...
extension Bugs {
    ...
    @NSManaged public var related_entity: NSSet?
...
extension Bugs {
    ...
    @NSManaged public func addToRelated_entity(_ values: NSSet)

    @objc(removeRelated_entity:)
    @NSManaged public func removeFromRelated_entity(_ values: NSSet)
